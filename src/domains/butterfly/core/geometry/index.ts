...
function createWingPetalShape(w: number, h: number): THREE.Shape {
  ...
  // Sharp corner (CSS top-left = Three.js BOTTOM-left)
  shape.moveTo(-w, -h * 0.5); // was +h*0.5

  shape.bezierCurveTo(
    -w * 0.35,
    -h * 0.5, // cp1  — was +h*0.5
    0,
    -h * 0.15, // cp2  — was +h*0.15
    0,
    0
  );
  ...
  shape.bezierCurveTo(
    ...
    h * 0.5, // cp1  — was -h*0.5
    -w,
    h * 0.25, // cp2  — was -h*0.25
    -w,
    0
  );

  shape.lineTo(-w, -h * 0.5); // close back to sharp corner
